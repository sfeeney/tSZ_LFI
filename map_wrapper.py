...
numerical_parameters = {
        ...
        # do you want the code to pester you with prinouts?
        'verbose': True,
        
        # angular size of the final map in radians
        ...
        'map_pixel_size': 0.1/60.*np.pi/180,
...
cosmology_parameters = {
        ...
        'TCMB': 2.726,# K
        'delta_c': 1.686,
        'c0': 2.99792458e5, #km/s, to convert H into Mpc^-1 when needed
...
map_functions.map_generate_dndOmega(numerical_parameters, cosmology_parameters, path)
# generates the 2D number density of sources and stores in 'path'

map_functions.map_generate_yprofiles(numerical_parameters, cosmology_parameters, path)
# generates the y-profiles and stores in 'path'
